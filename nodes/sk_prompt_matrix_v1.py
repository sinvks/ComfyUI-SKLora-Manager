...
class SK_PromptMatrix_V1:
    """
    SK Prompt Matrix Sampler V1
    功能：接收多行文本作为矩阵输入，每行代表一个维度，支持维度采样与段内词组随机抽取。
    """
    ...
    def execute(self, text_input, pick_count, sort_mode, input_sep, output_sep, seed):
        # 步骤 A: 预处理 - 按行切分并剔除空行
...
NODE_CLASS_MAPPINGS = {
    "SK_PromptMatrix_V1": SK_PromptMatrix_V1
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "SK_PromptMatrix_V1": "SK Prompt Matrix Sampler V1"
}
