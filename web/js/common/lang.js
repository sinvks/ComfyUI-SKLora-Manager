...
const translations = {
    "zh-CN": {
        ...
        civitai_key_test_label: "API Key 检测",
        civitai_key_test: "测试",
        civitai_key_test_idle: "未测试",
        civitai_key_testing: "测试中...",
        civitai_key_test_success: "Civitai API Key 可用",
        civitai_key_test_missing: "请先输入 Civitai API Key",
        civitai_key_test_invalid: "Civitai API Key 无效或已过期",
        civitai_key_test_forbidden: "Civitai API Key 权限不足",
        civitai_key_test_network: "无法连接 Civitai，请检查网络或代理设置",
        civitai_key_test_http: "Civitai 请求失败，状态码: {0}",
        civitai_key_test_failed: "Civitai API Key 测试失败",
        proxy_settings: "代理设置",
        ...
        llm_custom_hint: "提示：自定义模式仅支持兼容 OpenAI 协议的接口 (如 OneAPI, OpenRouter, SiliconFlow 等)。",
        ...
        llm_provider_llamacpp: "llama.cpp",
        llm_provider_mimo: "MiMo",
        llm_provider_zhipu: "智谱 AI",
        llm_provider_xflow: "xFlow API 聚合",
        llm_provider_nvidia: "NVIDIA NIM",
        llm_provider_custom: "自定义 / 其他",
        llm_custom_hint: "仅支持兼容 OpenAI API 的模型，如 Moonshot、Yi、OneAPI 等。",
    ...
    "zh-TW": {
        ...
        civitai_key_test_label: "API Key 檢測",
        civitai_key_test: "測試",
        civitai_key_test_idle: "未測試",
        civitai_key_testing: "測試中...",
        civitai_key_test_success: "Civitai API Key 可用",
        civitai_key_test_missing: "請先輸入 Civitai API Key",
        civitai_key_test_invalid: "Civitai API Key 無效或已過期",
        civitai_key_test_forbidden: "Civitai API Key 權限不足",
        civitai_key_test_network: "無法連接 Civitai，請檢查網路或代理設定",
        civitai_key_test_http: "Civitai 請求失敗，狀態碼: {0}",
        civitai_key_test_failed: "Civitai API Key 測試失敗",
        proxy_settings: "代理設置",
        proxy_placeholder: "例如: http://127.0.0.1:7890",
        ...
        llm_base_url: "API Base URL",
        llm_custom_hint: "提示：自定義模式僅支持兼容 OpenAI 協議的接口 (如 OneAPI, OpenRouter, SiliconFlow 等)。",
        ...
        llm_custom_hint: "僅支援相容 OpenAI API 的模型，如 Moonshot、Yi、OneAPI 等。",
    ...
    "en-US": {
        ...
        civitai_key_test_label: "API Key Test",
        civitai_key_test: "Test",
        civitai_key_test_idle: "Not tested",
        civitai_key_testing: "Testing...",
        civitai_key_test_success: "Civitai API Key is valid",
        civitai_key_test_missing: "Enter a Civitai API Key first",
        civitai_key_test_invalid: "Civitai API Key is invalid or expired",
        civitai_key_test_forbidden: "Civitai API Key does not have permission",
        civitai_key_test_network: "Cannot reach Civitai. Check network or proxy settings",
        civitai_key_test_http: "Civitai request failed, status: {0}",
        civitai_key_test_failed: "Civitai API Key test failed",
        ...
        llm_base_url: "API Base URL",
        llm_custom_hint: "Tip: Custom mode only supports OpenAI-compatible APIs (e.g. OneAPI, OpenRouter, SiliconFlow, etc).",
        ...
        llm_custom_hint: "Only supports OpenAI API-compatible models, such as Moonshot, Yi, OneAPI, etc.",
